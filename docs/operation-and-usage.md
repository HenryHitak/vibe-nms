...
- Dashboard search box에서 Enter를 누르면 첫 번째 검색 결과 장치 상세를 엽니다.
...
- Offline Ping은 숨길 수 있고, 숨긴 상태에서는 오른쪽 count rail만 남습니다.
- Dashboard는 백엔드 monitoring 데이터를 60초마다 새로 읽습니다. 브라우저가 직접 ping을 보내지 않습니다.
- USER 계정 메뉴는 Dashboard와 Alert Center만 보여줍니다.
- USER Alert Center는 notification list만 보여줍니다. ADMIN은 alert 처리, mute, acknowledge, close 기능을 계속 사용합니다.
